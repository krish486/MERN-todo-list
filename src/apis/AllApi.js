...
export let updateDataApi = async (id, data) => {
    try {
        await axios.put(`https://mern-todo-list-hzih.onrender.com/api/lists/update/${id}`, data)
    }
    catch (err) {
...
export let deleteDataApi = async (id) => {
    try {
        await axios.delete(`https://mern-todo-list-hzih.onrender.com/api/lists/delete/${id}`)
    }
    catch (err) {
